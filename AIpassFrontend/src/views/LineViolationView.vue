<template>
  <div class="enforcement">
    ...
    <div class="section-header">
      <h2 class="section-title">* 실선 침범 위반 차량 상세 정보 조회</h2>
      <div class="section-actions">
        <button class="btn-cctv" @click="showStreamModal = true" title="실시간 실선 침범 감지 모니터">
        ...
        <div class="images-stack">
          <div class="image-main-wrap">
            ...
            <img
              ...
              :src="'/ai-line/images/' + selectedItem.srcImageUrl"
              alt="차량 전체 사진"
          ...
          <div class="image-plate-wrap">
            ...
            <img
              ...
              :src="'/ai-line/images/' + selectedItem.imageUrl"
              alt="번호판"
              @error="$event.target.style.display='none'"
            />
            <div v-else class="no-image">이미지 없음</div>
